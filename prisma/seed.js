    ...
    data: [
      {
        ...
        size: 2048000,
        mimeType: "image/jpeg",
        path: "https://example.com/uploads/vacation.jpg",
        userId: alice.id,
      ...
      },
      {
        ...
        size: 512000,
        mimeType: "image/png",
        path: "https://example.com/uploads/portrait.png",
        userId: alice.id,
        folderId: alicePhotos.id,
      },
      {
        ...
        path: "https://example.com/uploads/resume.pdf",
        userId: alice.id,
      ...
      },
      {
        ...
        size: 4096,
        mimeType: "text/plain",
        path: "https://example.com/uploads/notes.txt",
        userId: alice.id,
    ...
    data: [
      {
        ...
        path: "https://example.com/uploads/app.js",
        userId: bob.id,
      ...
      },
      {
        ...
        path: "https://example.com/uploads/readme.md",
        userId: bob.id,
        folderId: bobProjects.id,
      },
    ],
